...
module.exports = async (email, subject, url, name) => {
  try {
    ...
    await transporter.sendMail({
      from: '"Teach Memory Game", <techmemorygame@gmail.com>',
      to: email,
      subject: subject,
      html: `
      <p style="font-weight:bold;">Hello, ${name}</p>
      <p>Are you ready to gain access to all of the assets we prepared for customer's of Teach Memory Game.</p>
      ...
      <p>This link will verify your email address, and then you’ll officially be a part of the Teach Memory Game.</p>
      <p>See you there!</p>
      <p>Best regards, the Tech Memory Game team.</p>
      `,
    });
